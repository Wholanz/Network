...
public class myHttpServer2 extends Thread {
    ...
    private myHttpServer2(String data, String encoding, String MIMEType, int port) throws UnsupportedEncodingException {
    ...
    public myHttpServer2(byte[] data, String encoding, String MIMEType, int port)throws UnsupportedEncodingException {
        this.content=data;
        this.port=port;
        ...
        String postToAnotherServer = "Another POST /server1.html HTTP/1.1\r\n"+
                "Accept: */*\r\n"+
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    /************************* For post request to get local html********************************************/
                    else
                    if (request.toString().indexOf("POST") >= 0){


                        if (request.toString().indexOf("jumpto2") >= 0 || request.toString().indexOf("server2.html") >= 0){
                    ...
                    /****************************** send encrypted message  ****************************************************/
                                ...
                                out.flush();
                    /********************************** If the request is from local, send the html directly *************************************/
                            }else{
                                out.write(content);
                                out.flush();
                            }
                        }
                        /**************************** Get html from another server ***********************************************/
                        else {
                            System.out.println("client wants to jump!");
                            String anotherIp = "127.0.0.1";
                            int anotherPort = 2222;
    ...
    public static void main(String[] args) {
        try {
            ...
            */
            ...
            InputStream in=new FileInputStream("server2.html");
            ...
            */
            ...
            Thread t=new myHttpServer2(data, encoding, contentType, port);
            t.start();
